...
function newobject:GetTextSelectionBoundaries()
  local bounds = {}
  self:ValidateSelection()
  return {start={x=self.textindicatorstartx,y=self.textindicatorstarty},stop={x=self.textindicatorstopx,y=self.textindicatorstopy}}
end
