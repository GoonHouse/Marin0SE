...
-- textinput object
local newobject = loveframes.NewObject("textimp", "loveframes_object_textimp", true)
...
function newobject:initialize()
  ...
  self.textselectionstartx = nil
  self.textselectionstarty = nil
  self.textselectionstopx = nil
  self.textselectionstopy = nil
...
--[[---------------------------------------------------------
	...
	- desc: gets the object's placeholder text
--]]---------------------------------------------------------
function newobject:SetSelection(mode)
  
  
  
  if mode == 'shift_home' then
    self.textindicatorstopx = self:GetIndicatorX()
    self.textindicatorstopy = self:GetIndicatorY()
    -- get cursor position to textselectionstop
    -- set beginning of line to textselectionstart
  elseif mode == 'shift_end' then
    -- get cursor position to textselectionstart
    -- set beginning of line to textselectionstop
  elseif mode == 'shift_down' then
    -- if multiline, set the textselectionstart before moving
    -- follow the cursor, do the text
  end
	return self.placeholder
...
function newobject:SetSelectionStart(x, y)
  x = x or self:GetIndicatorX()
  y = y or self:GetIndicatorY()
  self.textindicatorstartx = x
  self.textindicatorstarty = y
end
...
function newobject:SetSelectionStop(x, y)
  x = x or self:GetIndicatorX()
  y = y or self:GetIndicatorY()
  self.textindicatorstopx = x
  self.textindicatorstopy = y
end
...
function newobject:ResetSelection()
  self.hastextselection = false
  self.textindicatorstartx = nil
  self.textindicatorstarty = nil
  self.textindicatorstopx = nil
  self.textindicatorstopy = nil
end