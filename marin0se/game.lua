		...
		if player1.animationdirection == "left" and player1.animationstate ~= "idle" then
			if not player1.spring and not player1.springhigh then
				if windtable[1] == "left" then
					player1.speedx = player1.speedx - ((windtable[2]/100)/2)
					elseif windtable[1] == "right" then
					player1.speedx = player1.speedx + (windtable[2]/100)
				end
			else
